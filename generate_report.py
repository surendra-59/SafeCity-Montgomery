...
BRIGHT_DATA_HOST = st.secrets["BRIGHT_DATA_HOST"] or os.environ.get("BRIGHT_DATA_HOST")
BRIGHT_DATA_PORT = st.secrets["BRIGHT_DATA_PORT"] or os.environ.get("BRIGHT_DATA_PORT")
BRIGHT_DATA_USERNAME = st.secrets["BRIGHT_DATA_USERNAME"] or os.environ.get("BRIGHT_DATA_USERNAME")
BRIGHT_DATA_PASSWORD = st.secrets["BRIGHT_DATA_PASSWORD"] or os.environ.get("BRIGHT_DATA_PASSWORD")
